    ...
    <div className="cyber-container">
      ...
      <div className="simulation-canvas">
        <svg viewBox="0 0 800 800" className="intersection-svg">
          ...
          <line x1="400" y1="0" x2="400" y2="800" stroke="#22222a" strokeWidth="4" strokeDasharray="20,20" />
          
          {/* East-West Road */}
          <rect x="0" y="340" width="800" height="120" fill="#111116" />
          <line x1="0" y1="400" x2="800" y2="400" stroke="#22222a" strokeWidth="4" strokeDasharray="20,20" />
